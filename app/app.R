...
ui <- dashboardPage(
  ...
  dashboardBody(
    ...
    font-weight: 500; font-size: 500; text-shadow: 3px 3px 3px #aaa; line-height: 1; 
     color: #404040;"),
        h2(strong("STAT-613"), align="center", style = "font-family:500px; 'Times', serif;
    font-weight: 500; font-size: 500; text-shadow: 3px 3px 3px #aaa; line-height: 1; 
     color: #404040;"),
        h2(strong("Team G"), align="center", style = "font-family:500px; 'Times', serif;
    font-weight: 500; font-size: 500; text-shadow: 3px 3px 3px #aaa; line-height: 1; 
     color: #404040;"),
        h4(strong("Aliya Alimujiang"), align="center", style = "font-family:500px; 'Times', serif;
    font-weight: 500; font-size: 500; text-shadow: 3px 3px 3px #aaa; line-height: 1; 
     color: #404040;"),
        h4(strong("Sujata Biradar"), align="center", style = "font-family:500px; 'Times', serif;
    font-weight: 500; font-size: 500; text-shadow: 3px 3px 3px #aaa; line-height: 1; 
     color: #404040;"),
        h4(strong("Rui Huang"), align="center", style = "font-family:500px; 'Times', serif;
    font-weight: 500; font-size: 500; text-shadow: 3px 3px 3px #aaa; line-height: 1; 
     color: #404040;")
      ),
      tabItem(
